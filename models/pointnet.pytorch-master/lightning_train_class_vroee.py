...
if __name__ == "__main__":
    ...
    class PointNetCls_light(pl.LightningModule):
        ...
        def prepare_data(self):
            ...
            self.workers = 4  # was 4
            self.nepoch = 5
            self.dataset_type = 'shapenet'

            # dir_path = os.path.dirname(os.path.realpath(__file__))
            # self.dataset = os.path.join(dir_path,'shapenetcore_partanno_segmentation_benchmark_v0')
            self.dataset = r'D:\Roee_Yevgeni\pointnet.pytorch\shapenetcore_partanno_segmentation_benchmark_v0\shapenetcore_partanno_segmentation_benchmark_v0'
    ...
    trainer = pl.Trainer(logger=tb_logger, max_epochs=50, log_save_interval=20, fast_dev_run=False, gpus=-1)
